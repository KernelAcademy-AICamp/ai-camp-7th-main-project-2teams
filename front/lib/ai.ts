...
## 태그 수 규칙
- 0개: 내용 파악 불가(로그인·오류·광고 페이지), 또는 주제는 뚜렷하나 위 12개 대분류 어디에도 안 맞음(종교·법률·임상의료·정치·프로스포츠 관전·반려동물 등) → 억지 태깅 금지, 빈 배열 반환(태그 자체를 생성하지 않음)
- 1개: 대분류만 명확
...
5. 어느 대분류도 안 맞거나 툴·로그인·정체불명이면 0태그(억지 태깅 금지).
