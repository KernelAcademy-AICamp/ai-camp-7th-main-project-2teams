...
3. 학습: 주제가 12개 도메인 밖(수학·어학·자격증 시험·학습법 등)일 때만. 커리큘럼형 코스·부트캠프·완주반도 주제가 특정 도메인이면 그 도메인(형식은 중분류 강의) — Next.js 완주반="개발", ML 코스="AI/ML", 비즈니스 스쿨="비즈니스".
...
- 제휴마케팅·수익화 방법론(쿠팡 파트너스·애드센스·부업 쇼핑몰 만들기) = 비즈니스(쇼핑 아님). 형식은 강의/아티클, 플랫폼명은 소분류. 제목의 "쇼핑몰"·"쇼핑 쇼츠" 같은 문자열을 쇼핑으로 흡수 금지 — 구매 대상 상품·판매 페이지일 때만 쇼핑.
...
제목: 부업으로 쇼핑몰 만들어 월 100만원 — 제휴마케팅 입문 / URL: youtube.com/watch → {"tags":[{"tag":"비즈니스","confidence":0.85},{"tag":"강의","confidence":0.8}]}
